...
Xt_normal_arch_lm <- lm(Xt~t, data=df_Xt_normal_arch_q1)
summary(Xt_normal_arch_lm)

Xt_normal_arch_res <- Xt_normal_arch_lm$residuals
# Calcoliamo la skew e la kurtosi
moments::skewness(Xt_normal_arch_res)                  # theoretical value 0.
moments::kurtosis(Xt_normal_arch_res)                  # theoretical value 3.
# La skew è pari a -0.419207; questo indica una leggera asimmetria negativa, tuttavia,
# il suo valore è prossimo a zero, quindi la sua distribuzione potrebbe essere
# considerata approssimativamente simmetrica.
# La kurtosi è pari a 3.037705; questo indica che la distribuzione è leggermenete leptocurtica, 
# cioè ha code più pesanti rispetto ad una normale.

plot(Xt_normal_arch_lm,1) # Residuals vs Fitted
plot(Xt_normal_arch_lm,3) # Scale-location
...
Xt_normal_arch_bp <- lmtest::bptest(formula = Xt~t, varformula=NULL, studentize = TRUE, data=df_Xt_normal_arch_q1)
show(Xt_normal_arch_bp)
# Si ha un p-value di 0.7183 > 0.05, quindi, non possiamo rigettare l'ipotesi nulla di 
# omoschedasticità in favore  dell'ipotesi alternativa di eteroschedasticità

# Test WHITE sui residui del modello lineare
Xt_normal_arch_w <- lmtest::bptest(formula = Xt~t, varformula = ~ t+I(t^2), studentize = TRUE, data=df_Xt_normal_arch_q1)
show(Xt_normal_arch_w)
# Si ha un p-value di 0.6286 > 0.05, quindi, non possiamo rigettare l'ipotesi nulla di 
...
# Per tutti e tre i test si ha un p-value elevato, ciò significa che non ci sono prove
...
# La skew è pari a 0.213614; questo indica una leggera asimmetria verso destra, tuttavia,
# il suo valore è prossimo a zero, quindi la sua distribuzione potrebbe essere
# considerata approssimativamente simmetrica.
# La kurtosi è pari a 6.309536; questo indica che la distribuzione è leptocurtica, 
# cioè ha code più pesanti rispetto ad una normale.
...
# Si ha un p-value di 0.6325 > 0.05, quindi, non possiamo rigettare l'ipotesi nulla di 
# omoschedasticità in favore  dell'ipotesi alternativa di eteroschedasticità
...
# Si ha un p-value di 0.2703 > 0.05, quindi, non possiamo rigettare l'ipotesi nulla di 
# omoschedasticità in favore  dell'ipotesi alternativa
...
# La skew è pari a -1.948654; questo indica una forte asimmetria verso sinistra, tuttavia,
# con una cosa lunga negativa.
# La kurtosi è pari a 9.674163; questo indica che la distribuzione è leptocurtica, 
# cioè ha code più pesanti rispetto ad una normale.
...
# Si ha un p-value di  0.9437 > 0.05, quindi, non possiamo rigettare l'ipotesi nulla di 
# omoschedasticità in favore  dell'ipotesi alternativa di eteroschedasticità
...
# Si ha un p-value di 0.8641 > 0.05, quindi, non possiamo rigettare l'ipotesi nulla di 
# omoschedasticità in favore  dell'ipotesi alternativa
...
Xt <- Xt_normal_garch_q1_p1
df_Xt_normal_garch_q1_p1 <- data.frame(t = 1:length(Xt), X = Xt)

# Consideriamo un modello lineare
Xt_normal_garch_lm <- lm(Xt~t, data=df_Xt_normal_garch_q1_p1)
summary(Xt_normal_garch_lm)

Xt_normal_garch_res <- Xt_normal_garch_lm$residuals
# Calcoliamo la skew e la kurtosi
moments::skewness(Xt_normal_garch_res)                  # theoretical value 0.
moments::kurtosis(Xt_normal_garch_res)                  # theoretical value 3.
# La skew è pari a 0.0003659294; il suo valore è prossimo a zero, quindi la sua distribuzione 
# viene considerata approssimativamente simmetrica.
# La kurtosi è pari a 3.33351; questo indica che la distribuzione è leggermenete leptocurtica, 
# cioè ha code più pesanti rispetto ad una normale.

plot(Xt_normal_garch_lm,1) # Residuals vs Fitted
plot(Xt_normal_garch_lm,3) # Scale-location
# Dal grafico "Residuals vs Fitted" possiamo notare che i residui del modello sono distribuiti in modo
# omogeneo intorno alla linea rossa LOESS; questo indica che i residui sono stazionari.

# Test BREUSCH-PAGAN sui residui del modello lineare
Xt_normal_garch_bp <- lmtest::bptest(formula = Xt~t, varformula=NULL, studentize = TRUE, data=df_Xt_normal_garch_q1_p1)
show(Xt_normal_garch_bp)
# Si ha un p-value di 2.2e-16 < 0.05, quindi, possiamo rigettare l'ipotesi nulla di 
# omoschedasticità in favore  dell'ipotesi alternativa di eteroschedasticità

# Test WHITE sui residui del modello lineare
Xt_normal_garch_w <- lmtest::bptest(formula = Xt~t, varformula = ~ t+I(t^2), studentize = TRUE, data=df_Xt_normal_garch_q1_p1)
show(Xt_normal_garch_w)
# Si ha un p-value di 2.2e-16 < 0.05, quindi, possiamo rigettare l'ipotesi nulla di 
# omoschedasticità in favore  dell'ipotesi alternativa

# Plot of the autocorrelogram.
y <- Xt_normal_garch_lm$residuals
length <- length(y)
maxlag <- ceiling(10*log10(length))
Aut_Fun_y <- acf(y, lag.max = maxlag, type="correlation", plot=FALSE)
ci_90 <- qnorm((1+0.90)/2)/sqrt(length)
...
# Test Ljiung-box
y <- Xt_normal_garch_res
Box.test(y, lag = 1, type = "Ljung-Box", fitdf = 0)

# Test Durbin-Watson
dwtest(Xt_normal_garch_lm, alternative="two.sided")

# Test Breusch-Godfrey
bgtest(Xt_normal_garch_lm, order=5, type="Chisq")
...
Xt <- Xt_t_student_symmetric_garch_q1_p1
df_Xt_t_student_symmetric_garch_q1_p1 <- data.frame(t = 1:length(Xt), X = Xt)

# Consideriamo un modello lineare
Xt_t_student_symmetric_garch_lm <- lm(Xt~t, data=df_Xt_t_student_symmetric_garch_q1_p1)
summary(Xt_t_student_symmetric_garch_lm)

Xt_t_student_symmetric_garch_res <- Xt_t_student_symmetric_garch_lm$residuals
# Calcoliamo la skew e la kurtosi
moments::skewness(Xt_t_student_symmetric_garch_res)                  # theoretical value 0.
moments::kurtosis(Xt_t_student_symmetric_garch_res)                  # theoretical value 3.
# La skew è pari a 0.0.6906698; il suo valore è positivo e la sua distribuzione è leggermenete
# asimmetrica verso destra.
# La kurtosi è pari a 18.88783; questo indica che la distribuzione è leggermenete leptocurtica, 
# cioè ha code più pesanti rispetto ad una normale.

plot(Xt_t_student_symmetric_garch_lm,1) # Residuals vs Fitted
plot(Xt_t_student_symmetric_garch_lm,3) # Scale-location
# Dal grafico "Residuals vs Fitted" possiamo notare che i residui del modello sono distribuiti in modo
# omogeneo intorno alla linea rossa LOESS; questo indica che i residui sono stazionari.

# Test BREUSCH-PAGAN sui residui del modello lineare
Xt_t_student_symmetric_garch_bp <- lmtest::bptest(formula = Xt~t, varformula=NULL, studentize = TRUE, data=df_Xt_t_student_symmetric_garch_q1_p1)
show(Xt_t_student_symmetric_garch_bp)
# Si ha un p-value di 0.0009746 < 0.05, quindi, possiamo rigettare l'ipotesi nulla di 
# omoschedasticità in favore  dell'ipotesi alternativa di eteroschedasticità

# Test WHITE sui residui del modello lineare
Xt_t_student_symmetric_garch_w <- lmtest::bptest(formula = Xt~t, varformula = ~ t+I(t^2), studentize = TRUE, data=df_Xt_t_student_symmetric_garch_q1_p1)
show(Xt_t_student_symmetric_garch_w)
# Si ha un p-value di 0.000879 < 0.05, quindi, possiamo rigettare l'ipotesi nulla di 
# omoschedasticità in favore  dell'ipotesi alternativa

# Plot of the autocorrelogram.
y <- Xt_t_student_symmetric_garch_lm$residuals
length <- length(y)
maxlag <- ceiling(10*log10(length))
Aut_Fun_y <- acf(y, lag.max = maxlag, type="correlation", plot=FALSE)
ci_90 <- qnorm((1+0.90)/2)/sqrt(length)
...
Xt <- Xt_t_student_asymmetric_garch_q1_p1
df_Xt_t_student_asymmetric_garch_q1_p1 <- data.frame(t = 1:length(Xt), X = Xt)

# Consideriamo un modello lineare
Xt_t_student_asymmetric_garch_lm <- lm(Xt~t, data=df_Xt_t_student_asymmetric_garch_q1_p1)
...
# La skew è pari a -2.184469; il suo valore è negativo e la sua distribuzione è
# asimmetrica verso sinistra con una coda lunga negativa.
# La kurtosi è pari a 11.15036; questo indica che la distribuzione è leggermenete leptocurtica, 
# cioè ha code più pesanti rispetto ad una normale.
...
# Test BREUSCH-PAGAN sui residui del modello lineare
Xt_t_student_asymmetric_garch_bp <- lmtest::bptest(formula = Xt~t, varformula=NULL, studentize = TRUE, data=df_Xt_t_student_asymmetric_garch_q1_p1)
show(Xt_t_student_asymmetric_garch_bp)
# Si ha un p-value di 0.9107 > 0.05, quindi, non possiamo rigettare l'ipotesi nulla di 
# omoschedasticità in favore  dell'ipotesi alternativa di eteroschedasticità

# Test WHITE sui residui del modello lineare
Xt_t_student_asymmetric_garch_w <- lmtest::bptest(formula = Xt~t, varformula = ~ t+I(t^2), studentize = TRUE, data=df_Xt_t_student_asymmetric_garch_q1_p1)
show(Xt_t_student_asymmetric_garch_w)
# Si ha un p-value di 0.4534 > 0.05, quindi, non possiamo rigettare l'ipotesi nulla di 
# omoschedasticità in favore  dell'ipotesi alternativa
...
ggplot(Plot_Aut_Fun_y, aes(x=lag, y=acf)) + 
  ...
  theme(plot.title=element_text(hjust = 0.5), 
        ...
        plot.caption = element_text(hjust = 1.0),
        legend.key.width = unit(0.8,"cm"), legend.position="bottom")
# nel grafico dell'autocorrelogramma possiamo notare che i valori sembrano avere un trend iniziale
# per poi avere dal 20 lag in poi dei valori che oscillano all'interno dell'intervallo 
...
# Consideriamo un modello lineare
Xt_normal_garch_lm <- lm(Xt~t, data=df_Xt_normal_garch_q1_p2)
summary(Xt_normal_garch_lm)
...
moments::skewness(Xt_normal_garch_res)                  # theoretical value 0.
moments::kurtosis(Xt_normal_garch_res)                  # theoretical value 3.
# La skew è pari a 0.001028844; il suo valore è prossimo a zero, quindi la sua distribuzione 
# viene considerata simmetrica.
# La kurtosi è pari a 3.356408; questo indica che la distribuzione è leggermenete leptocurtica, 
# cioè ha code più pesanti rispetto ad una normale.
...
# Test BREUSCH-PAGAN sui residui del modello lineare
Xt_normal_garch_bp <- lmtest::bptest(formula = Xt~t, varformula=NULL, studentize = TRUE, data=df_Xt_normal_garch_q1_p2)
show(Xt_normal_garch_bp)
# Si ha un p-value di 2.2e-16 < 0.05, quindi, possiamo rigettare l'ipotesi nulla di 
# omoschedasticità in favore  dell'ipotesi alternativa di eteroschedasticità

# Test WHITE sui residui del modello lineare
Xt_normal_garch_w <- lmtest::bptest(formula = Xt~t, varformula = ~ t+I(t^2), studentize = TRUE, data=df_Xt_normal_garch_q1_p2)
show(Xt_normal_garch_w)
# Si ha un p-value di 2.2e-16 < 0.05, quindi, possiamo rigettare l'ipotesi nulla di 
# omoschedasticità in favore  dell'ipotesi alternativa
...
# Consideriamo un modello lineare
Xt_t_student_symmetric_garch_lm <- lm(Xt~t, data=df_Xt_t_student_symmetric_garch_q1_p2)
summary(Xt_t_student_symmetric_garch_lm)
...
moments::skewness(Xt_t_student_symmetric_garch_res)                  # theoretical value 0.
moments::kurtosis(Xt_t_student_symmetric_garch_res)                  # theoretical value 3.
# La skew è pari a 0.02159764; il suo valore è positivo e vicino allo zero; quindi, la sua distribuzione
# è vicina alla simmetria.
# La kurtosi è pari a 5.617089; questo indica che la distribuzione è leptocurtica, 
# cioè ha code più pesanti rispetto ad una normale.
...
# Test BREUSCH-PAGAN sui residui del modello lineare
Xt_t_student_symmetric_garch_bp <- lmtest::bptest(formula = Xt~t, varformula=NULL, studentize = TRUE, data=df_Xt_t_student_symmetric_garch_q1_p2)
show(Xt_t_student_symmetric_garch_bp)
# Si ha un p-value di 0.419 > 0.05, quindi, non possiamo rigettare l'ipotesi nulla di 
# omoschedasticità in favore  dell'ipotesi alternativa di eteroschedasticità

# Test WHITE sui residui del modello lineare
Xt_t_student_symmetric_garch_w <- lmtest::bptest(formula = Xt~t, varformula = ~ t+I(t^2), studentize = TRUE, data=df_Xt_t_student_symmetric_garch_q1_p2)
show(Xt_t_student_symmetric_garch_w)
# Si ha un p-value di 0.08884 > 0.05, quindi, non possiamo rigettare l'ipotesi nulla di 
# omoschedasticità in favore  dell'ipotesi alternativa
